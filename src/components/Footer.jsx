...
const Footer = ({ className = "" }) => {
  return (
    <div
      className={`w-[94vw] mx-auto relative h-[15.5rem] text-left text-[1rem] text-white font-saira ${className}`}
    >
      <div className="absolute top-[0rem] left-[0rem] rounded-22xl bg-giga-fiber-lila w-[94vw] mx-auto h-[15.5rem]" />
      <img
