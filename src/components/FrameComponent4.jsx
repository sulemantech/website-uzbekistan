...
const FrameComponent4 = forwardRef(
  ({ isMobile, scrollToFrame5, scrollToFrame6, scrollToFrame7 }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className="flex flex-col lg:flex-row justify-center max-md:items-center flex-wrap mt-4 gap-3 max-md:mb-10 p-2 max-md:px-0"
      >
        {cardData.map((card, index) => (
          ...
          >
            ...
            >
              ...
              <img
                className="absolute group-hover:scale-105 transition-all top-0 left-0 w-full h-full object-cover max-md:object-fill"
                alt={card.title}
                src={card.imgSrc}
              />
