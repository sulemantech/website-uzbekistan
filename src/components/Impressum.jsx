        ...
        <div className="w-full max-w-[78.125rem] rounded-2xl bg-white flex flex-col items-start justify-start py-[6.25rem] pl-[0.25rem] pr-[0.25] md:pr-[2.5rem] box-border">
          <div className="self-stretch flex flex-col items-start justify-start">
            <div className="self-stretch flex flex-col items-start justify-start gap-[2.5rem]">
              <div className="self-stretch flex flex-col items-start justify-start py-[0rem] px-[0.25] md:px-[5.75rem]">
                <img
              ...
              <div className="self-stretch flex flex-col items-start justify-start py-[0rem] px-[0.25rem] md:px-[5.687rem] gap-[2.5rem] text-[1.875rem]">
                <div className="self-stretch flex flex-col items-start justify-start">
                  <div className="self-stretch flex flex-row items-start justify-start">
                    <div className="w-full max-w-[33.313rem] flex flex-col items-start justify-start gap-[1.25rem]">
                      <div className="flex flex-row items-center justify-center">
                        <b className="w-full max-w-[32.375rem] relative leading-[125%] uppercase inline-block shrink-0">
                          Registergericht
                        </b>
                      </div>
                      <div className="w-full max-w-[32.375rem] flex flex-col items-start justify-start text-[1rem] text-black">
