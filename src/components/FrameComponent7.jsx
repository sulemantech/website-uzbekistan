      ...
      >
        <div className="flex justify-between w-full space-x-10 rounded-2xl max-xl:flex-col max-xl:space-y-5 max-xl:space-x-0 max-xl:h-fit">
          <div className="flex flex-col w-full space-y-4 xl:w-[533px]">
            ...
            <div className="min-w-[518px] max-xl:min-w-full xl:w-[518px] text-[16px] font-normal font-saira text-left  whitespace-pre-line">
             {t("frameComponent7_intro")}
            </div>
          </div>

          <div className="grid grid-cols-1 gap-8 w-[658px] max-xl:w-full xl:w-full max-xl:h-full xl:max-h-[574px] laptop:max-w-[658px] xl:h-fit">
