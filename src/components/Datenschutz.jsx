...
const Datenschutz = () => {
  ...
  return (
    <div className=" relative overflow-hidden flex flex-col items-center justify-start pt-[0rem] px-[2.187rem] pb-[2.5rem] box-border text-left text-[3.75rem] text-giga-fiber-lila font-saira-condensed">
      <video
        ...
        playsInline
      ></video>
      <div className="w-[90rem] [background:linear-gradient(180deg,_#281d57,_#1e1a2e)] h-[4.375rem] flex flex-col items-start justify-start py-[1.312rem] px-[3.062rem] box-border">
      ...
      <div className="w-[85.625rem] flex flex-col items-center justify-center py-[2.5rem] px-[2.562rem] box-border">
        <div className="w-[78.125rem] rounded-22xl bg-white flex flex-col items-start justify-start py-[6.25rem] pl-[0.25rem] pr-[2.5rem] box-border">
          <div className="self-stretch flex flex-col items-start justify-start">
            <div className="self-stretch flex flex-col items-start justify-start gap-[2.5rem]">
              <div className="flex flex-col items-start justify-start py-[0rem] px-[5.687rem] gap-[0.875rem]">
                <img
              ...
              <div className="w-[77.875rem] flex flex-col items-start justify-start py-[0rem] px-[5.687rem] box-border gap-[2.5rem] text-[1.875rem]">
                <div className="w-[66rem] flex flex-col items-start justify-start">
                  <div className="self-stretch flex flex-row items-start justify-start">
                    <div className="w-[68.375rem] flex flex-col items-start justify-start gap-[1.25rem]">
                      <div className="flex flex-row items-center justify-center">
                        <b className="w-[32.375rem] relative leading-[125%] uppercase inline-block shrink-0">
                          Inhaltsverzeichnis
                        </b>
                      ...
                      <div className="self-stretch flex flex-col items-start justify-start text-[1rem] text-black">
                        <div className="w-[66.25rem] relative leading-[125%] inline-block">
                          <p className="m-0">
                            ...
                            Daten verbunden sein. Damit diese Verarbeitungen für
                            Sie nachvollziehbar sind, möchten wir Ihnen mit den
                            folgenden Informationen einen Überblick zu diesen
                            Verarbeitungen verschaffen. Um eine faire
                            Verarbeitung zu gewährleisten, möchten wir Sie
                            außerdem über Ihre Rechte nach der Europäischen
                            Datenschutz-Grundverordnung (DSGVO) und dem
                            Bundesdatenschutzgesetz (BDSG) informieren.
                            Verantwortlich für die Datenverarbeitung ist die
                            GIGA FIBER Netz GmbH, 27-28, 60329 Frankfurt am
                            Main, Deutschland (nachfolgend auch als „wir“ oder
                            „uns“ bezeichnet).
                          </p>
                          <p className="m-0">&nbsp;</p>
                          <p className="m-0">
                            Wenn Sie Fragen oder Anregungen zu diesen
                            Informationen haben oder sich wegen der
                            Geltendmachung Ihrer Rechte an uns wenden möchten,
                            richten Sie Ihre Anfrage bitte an:
                          </p>
                          <p className="m-0">&nbsp;</p>
                          <p className="m-0">
                            GIGA FIBER Netz GmbHUntermainkai 27-2860329
                            Frankfurt am Main
                          </p>
                          <p className="m-0">&nbsp;</p>
                          <p className="m-0">
                ...
                <div className="self-stretch flex flex-col items-start justify-start gap-[2.5rem] text-[1rem] text-black">
                  <div className="self-stretch flex flex-col items-start justify-start">
                    <div className="self-stretch flex flex-row items-start justify-start">
                      <div className="w-[66.375rem] flex flex-col items-start justify-start gap-[1.25rem]">
                        ...
                        <div className="w-[66.375rem] flex flex-col items-start justify-start">
                          <div className="self-stretch relative leading-[125%]">
                  ...
                  <div className="w-[66.375rem] flex flex-col items-start justify-start text-[1.875rem] text-giga-fiber-lila">
                    <div className="flex flex-row items-start justify-start">
                      <div className="w-[69.5rem] flex flex-col items-start justify-start gap-[1.25rem]">
                        <div className="flex flex-row items-center justify-center">
                          <b className="w-[32.375rem] relative leading-[125%] uppercase inline-block shrink-0">
                            Haftungsausschluss
                          </b>
                        </div>
                        <div className="w-[68.625rem] flex flex-col items-start justify-start text-[1rem] text-black">
                          <div className="self-stretch relative leading-[125%]">
                ...
                <div className="self-stretch flex flex-col items-start justify-start gap-[1.25rem]">
                  <div className="flex flex-row items-center justify-center">
                    <b className="w-[33.625rem] relative leading-[125%] uppercase inline-block shrink-0">
                  ...
                  <div className="self-stretch flex flex-col items-start justify-start text-[1rem] text-black">
                    <div className="self-stretch relative leading-[125%]">
                      ...
                      <p className="m-0">
                        ...
                        >
                          <span>
                            <span className="[text-decoration:underline]">{`https://www.facebook.com/privacy/policies/cookies/?entry_point=cookie_policy_redirect&entry=0`}</span>
                          </span>
                        </a>
